...
//const u16 VoltageTab1[]={4100,4080,4050,4010,3955,3903,3863,3820,3785,3749,3600};
/*全局变量*/
...
u8 Battery_GetVoltage(u16 *voltage)
{
    ...
    {
        /* 计算公式(电路1/2分压) ： Voltage = ADC_Result *3000 *2 / 4096 */
        tmp_voltage = adc_value*375;//825
        *voltage    = tmp_voltage/256;//512
        ADC_TestPowerOFF();     
        return 1;
    }
    ADC_TestPowerOFF();     
