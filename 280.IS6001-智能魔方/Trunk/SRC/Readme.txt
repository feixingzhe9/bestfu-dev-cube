...
********************************************************************************
================================================================================
V3.00.00	时间：2016.06.02	硬件：IS6001 V4.04		修改：周雁
烧录文件：IS6001_V3.00.00_burn_64K.hex
升级文件：IS6001_V3.00.00_app_64K.upd
	  IS6001_V1.00.00_boot_64K.upd
库版本：  V1.02.00
说    明：
        1、移植新库至V1.02.00版本,此版本采用单区方案,433通讯加密,1M
================================================================================

================================================================================
V2.05.03	时间：2016.03.23	硬件：IS6001 V4.04		修改：周雁
烧录文件：IS6001_V2.05.03_burn.hex
升级文件：IS6001_V2.05.03_update.dat
说    明：
        1.修改部分库bug更新;
================================================================================

================================================================================
V2.05.02	时间：2016.03.21	硬件：IS6001 V4.04		修改：周雁
烧录文件：IS6001_V2.05.02_burn.hex
升级文件：IS6001_V2.05.02_update.dat
说    明：
        1.替换大版本的库V1.2.0，详情参阅V1.2.0的库修改内容(更新库);
================================================================================

================================================================================
V2.05.01	时间：2016.03.15	硬件：IS6001 V4.04		修改：周雁
烧录文件：IS6001_V2.05.01_burn.hex
升级文件：IS6001_V2.05.01_update.dat
说    明：
        1.替换大版本的库V1.2.0，详情参阅V1.2.0的库修改内容;
================================================================================
